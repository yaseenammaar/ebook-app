...
class Home extends CI_Controller {
	...
	public function __construct() { 
         ...
         define('SERVER_PATH',$_SERVER['DOCUMENT_ROOT'].'/ebook_app/');
 }
	...
	public function register(){
	  if(isset($_SESSION['is_login'])){
	   ...
	   $this->load->view("crazyspects/register",["title"=>"Register - Skilldd"]);  
	}

  function login(){
    $this->load->view("crazyspects/login",["title"=>"Login - Skilldd"]); 
  }
    ...
    public function profile(){
     ...
     $this->load->view("crazyspects/profile.php",["title"=>"Profile Details - Skilldd","page"=>"profile.php"]);   
    }
    ...
    public function create_thumbnail(){
      if(!isset($_SESSION['is_login'])){
        ...
        $title="Create Thumbnail - Skilldd";
    ...
    $data=["status"=>0];
     ...
     public function upload_json(){
         $serverpath=$_SERVER['DOCUMENT_ROOT'].'/thumb/uploads/';
     ...
     public function manage_users(){
         if($_SESSION['user']['is_admin']==1){
           $this->load->view("crazyspects/users",["title"=>"Manage Users - Skilldd","page"=>"users.php"]);  
         }else{
             return redirect('home');
         }
     }
