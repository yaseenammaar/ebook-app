                ...
                <tr role="row" class="odd">
                  <td>
                    <a href="<?php echo base_url('uploads/thumbnails/'.$thumb['thumbnail']) ?>" target="_blank"> 
                      <img src="<?php echo base_url('uploads/thumbnails/'.$thumb['thumbnail']) ?>" class="thumb-list" style="height:180px;width:320px;"> 
                    </a>
                  </td>
                  <td class="sorting_1">
                  ...
                  <div style="display:flex;margin-top:25%">
                   ...
                   <a class="btn btn-danger" style="color: black;border-radius: 20px;background-color: #AEE518;border-color: #AEE518;" href="<?php echo base_url('uploads/thumbnails/'.$thumb['thumbnail']) ?>" download><i class="fas fa-download"></i> Download</a>
                   </div>
                  </td>
                </tr>
              <?php }} ?>
